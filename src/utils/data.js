...
export const testimonialsData = [
  {
    comment: 
    "Liam's web development skills are a digital masterpiece, seamlessly blending functionality and aesthetics.",
    name: "Mark Zuckerberg",
    profession: "Founder and CEO, Facebook"
  },
  {
    comment: 
    "Liam crafts UI/UX experiences that are a virtual journey, leaving users in awe of his elegantly humanized designs.",
    name: "Jony Ive",
    profession: "Former Chief Design Officer, Apple"
  },
  {
    comment: 
    "In the vast digital landscape, Liam is the ultimate strategist, orchestrating online success with captivating digital marketing campaigns.",
    name: "Rand Fishkin",
    profession: "Co-Founder, Moz"
  },
  {
    comment: 
    "Liam's code is a spellbook that brings digital realms to life, weaving logic and creativity into functional symphonies.",
    name: "Satya Nadella",
